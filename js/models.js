...
class StoryList {
  ...
  async addStory(user, newStory) {
    try {
      ...
      // const response = await axios.post(`${BASE_URL}/stories`, data, { headers: { Authorization: `Bearer ${data.token}` } });
      const response = await axios({
        url: `${BASE_URL}/stories`,
        method: "POST",
        data: data,
        headers: {
          // Got token from class User. 
      ...
      const story = new Story({
        ...
        favorite: response.data.story.favorite
      });
